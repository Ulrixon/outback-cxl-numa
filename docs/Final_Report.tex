...
Three hardware environments are compared throughout this report: the original paper's primary cluster (CloudLab \texttt{r650}, CX-6 100\,Gbps), our RDMA reproduction (CloudLab \texttt{r320}, CX-3 56\,Gbps FDR), and our CXL/NUMA extension (CloudLab \texttt{c6420}, dual-socket NUMA as a CXL proxy). Table~\ref{tab:setup-diff} lists the key differences and their expected effect on results; full hardware listings appear in Appendix~\ref{app:hw}.
